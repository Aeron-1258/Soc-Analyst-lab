...
import { ShieldAlert, Search, Download, Activity, X } from 'lucide-react';
import { toast } from 'react-hot-toast';

const AlertsPage = () => {
  const { alerts, blacklist, setBlacklist } = useSocket();
        ...
        <div className="flex items-center gap-3">
          <div className="relative">
            ...
            <input 
              ...
              className="bg-slate-900/50 border border-slate-800 rounded-lg py-2 pl-10 pr-4 text-sm text-white focus:outline-none focus:border-neon-blue transition-all w-64"
              value={searchTerm}
              onChange={(e) => setSearchTerm(e.target.value)}
            />
          </div>
          <button className="flex items-center gap-2 px-4 py-2 bg-slate-800 hover:bg-slate-700 text-white rounded-lg text-sm transition-all">
                  ...
                  >
                    ...
                    <td className="px-6 py-4 text-right">
                      <button 
                        ...
                        className="text-neon-blue hover:text-white text-xs font-bold transition-colors"
                      >
                        Investigate
                      </button>
                    </td>
